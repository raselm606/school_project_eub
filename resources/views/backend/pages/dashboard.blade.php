...
{{--                class="fas fa-download fa-sm text-white-50"></i> Generate Report</a>--}}
    ...
    <div class="col-lg-12">
        ...
        <!-- Earnings (Monthly) Card Example -->
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card border-left-success shadow h-100 py-2 pointer" onclick="location.href='{{route('admin.all.product')}}'">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
        ...
        <!-- Earnings (Monthly) Card Example -->
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card border-left-info shadow h-100 py-2 pointer" onclick="location.href='{{route('admin.all.product')}}'">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
